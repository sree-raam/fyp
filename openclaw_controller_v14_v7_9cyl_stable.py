...
======================
OPENCLAW — LLM-ASSISTED AUTONOMOUS INSPECTION BENCHMARK  v14 (v7 movement + 9 cylinders)
...
Architecture (NEW — not patched from old code):
  ...
  ├─ CylinderRegistry   EMA-tracked, stable CYL_N labels, 9 target max
...
Key design decisions vs old code:
  ...
  • Cylinders: 9 targets for the current Gazebo layout; LiDAR discovery/numbering
...
class CFG:
    ...
    CYL_MAX_COUNT = 9      # maximum cylinders expected in current Gazebo layout
