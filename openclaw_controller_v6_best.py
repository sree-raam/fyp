#!/usr/bin/env python3
"""
OpenClaw v6 benchmark controller.

Implements optional Phase-2, direct benchmark runs, two-phase rotate-then-drive
navigation, robust home return, LLM strict JSON planning, dashboard, camera
fallback, CSV/JSON export, and 5-runs-per-model thesis data collection.
...
class Config:
    ...
    OLLAMA_TIMEOUT_S = float(os.environ.get("OPENCLAW_OLLAMA_TIMEOUT", "120"))
...
class MissionEngine:
    ...
    def run_single(self, model: str, command: str) -> RunMetrics:
        ...
        try:
            ...
            # Return-home is logged as its own metric. It does not by itself fail the run.
            result.success = (ROS_NODE.collision_count - start_collisions) <= 2
